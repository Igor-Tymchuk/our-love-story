...
export default function SlideCouple({ isActive }) {
  const { t } = useLanguage();
  ...
  return (
    <div className="relative w-full h-full overflow-hidden bg-[#0F0A0C]">
      ...
      <FloatingParticles count={15} color="rgba(231,177,177,0.2)" hearts />

      <div className="relative z-20 flex flex-col lg:flex-row-reverse items-center justify-center h-full px-6 md:px-16 gap-4 md:gap-8 lg:gap-16 py-16 md:py-8">
        <motion.div
        ...
        >
          ...
          <motion.div
            ...
            className="mt-8 h-px bg-gradient-to-r from-transparent via-[#E7B1B1] to-transparent origin-left"
          />
        </motion.div>
        ...
        >
          <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-[#E7B1B1]/10 border border-white/10 bg-white/5 backdrop-blur-sm p-3">
            <img
              src={IMAGES.couple2014}
              alt="Becoming a couple in 2014"
